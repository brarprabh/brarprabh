...
**ML & Data Science**
`PyTorch` `scikit-learn` `XGBoost` `LightGBM` `OpenCV` `Grad-CAM` `pandas` `NumPy`

**Tools & Infrastructure**
`Docker` `Git/GitHub` `Postman` `Netlify` `VS Code` `Linux` `Jupyter Notebook`
...
- **LeetCode** — 250+ problems solved in C++ · Focus: Dynamic Programming, Graphs, Backtracking
- **Core Strengths** — Time/space complexity optimisation, OOP, Systems thinking
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Prabhjot_Brar-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/prabhjot-brar-9a426b347)
...
[![LeetCode](https://img.shields.io/badge/LeetCode-brarprabh-FFA116?style=flat&logo=leetcode&logoColor=white)](https://leetcode.com/brarprabh)
